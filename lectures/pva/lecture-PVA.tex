...
\begin{alltt}
\hldef{A} \hlkwb{<-} \hlkwd{matrix}\hldef{(}\hlkwd{c}\hldef{(}
    \hlnum{0.2}\hldef{,} \hlnum{0.8}\hldef{,} \hlnum{1.0}\hldef{,} \hlnum{0.9}\hldef{,}
    \hlnum{0.4}\hldef{,} \hlnum{0.0}\hldef{,} \hlnum{0.0}\hldef{,} \hlnum{0.0}\hldef{,}
    \hlnum{0.0}\hldef{,} \hlnum{0.6}\hldef{,} \hlnum{0.0}\hldef{,} \hlnum{0.0}\hldef{,}
    \hlnum{0.0}\hldef{,} \hlnum{0.0}\hldef{,} \hlnum{0.8}\hldef{,} \hlnum{0.5}\hldef{),} \hlkwc{nrow}\hldef{=}\hlnum{4}\hldef{,} \hlkwc{byrow}\hldef{=}\hlnum{TRUE}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hldef{lam} \hlkwb{<-} \hlkwd{Re}\hldef{(eA}\hlopt{$}\hldef{values[}\hlnum{1}\hldef{])}
\hldef{lam}                              \hlcom{## Asymtotic growth rate}
\end{alltt}
\begin{verbatim}
## [1] 1.034908
\end{verbatim}
\begin{alltt}
\hldef{w} \hlkwb{<-} \hlkwd{Re}\hldef{(eA}\hlopt{$}\hldef{vectors[,}\hlnum{1}\hldef{])}
\hldef{w} \hlkwb{<-} \hldef{w}\hlopt{/}\hlkwd{sum}\hldef{(w)}                    \hlcom{## Stable age distribution}

\hldef{v} \hlkwb{<-} \hlkwd{Re}\hldef{(}\hlkwd{eigen}\hldef{(}\hlkwd{t}\hldef{(A))}\hlopt{$}\hldef{vectors[,}\hlnum{1}\hldef{])} \hlcom{## Reproductive value}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{z} \hlkwb{<-} \hlkwd{outer}\hldef{(v,w)}\hlopt{/}\hlkwd{c}\hldef{(v}\hlopt{%*%}\hldef{w)}
\hldef{z} \hlcom{## Sensitivites}
\end{alltt}
\begin{verbatim}
##           [,1]      [,2]       [,3]      [,4]
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{e} \hlkwb{<-} \hldef{A}\hlopt{*}\hldef{z}\hlopt{/}\hldef{lam}
\hldef{e}  \hlcom{## Elasticities}
\end{alltt}
\begin{verbatim}
##            [,1]      [,2]      [,3]       [,4]
...
## eigen() decomposition
## $values
## [1]  1.03490847+0.0000000i  0.01645661+0.3720685i  0.01645661-0.3720685i
## [4] -0.36782169+0.0000000i
## 
## $vectors
##               [,1]                  [,2]                  [,3]          [,4]
...
\end{verbatim}
\begin{alltt}
\hldef{v} \hlkwb{<-} \hlkwd{Re}\hldef{(}\hlkwd{eigen}\hldef{(}\hlkwd{t}\hldef{(A))}\hlopt{$}\hldef{vectors[,}\hlnum{1}\hldef{])}
\hldef{v}
\end{alltt}
\begin{verbatim}
...
\end{verbatim}
\begin{alltt}
\hldef{sen} \hlkwb{<-} \hlkwd{outer}\hldef{(v,w)}\hlopt{/}\hlkwd{c}\hldef{(v}\hlopt{%*%}\hldef{w)}
\hldef{sen}
\end{alltt}
\begin{verbatim}
##           [,1]      [,2]       [,3]      [,4]
...
\end{verbatim}
\begin{alltt}
\hldef{el} \hlkwb{<-} \hldef{A}\hlopt{*}\hldef{sen}\hlopt{/}\hldef{lam}
\hldef{el}
\end{alltt}
\begin{verbatim}
##            [,1]      [,2]      [,3]       [,4]
...
\end{verbatim}
\begin{alltt}
\hldef{A2} \hlkwb{<-} \hldef{A}
\hldef{A2[}\hlnum{1}\hldef{,}\hlnum{1}\hldef{]} \hlkwb{<-} \hldef{A[}\hlnum{1}\hldef{,}\hlnum{1}\hldef{]}\hlopt{+}\hlnum{0.1}
\hldef{lam2} \hlkwb{<-} \hlkwd{Re}\hldef{(}\hlkwd{eigen}\hldef{(A2)}\hlopt{$}\hldef{val[}\hlnum{1}\hldef{])}

\hldef{A3} \hlkwb{<-} \hldef{A}
\hldef{A3[}\hlnum{1}\hldef{,}\hlnum{2}\hldef{]} \hlkwb{<-} \hldef{A[}\hlnum{1}\hldef{,}\hlnum{2}\hldef{]}\hlopt{+}\hlnum{0.1}
\hldef{lam3} \hlkwb{<-} \hlkwd{Re}\hldef{(}\hlkwd{eigen}\hldef{(A3)}\hlopt{$}\hldef{val[}\hlnum{1}\hldef{])}

\hldef{(lam2}\hlopt{-}\hldef{lam)}\hlopt{/}\hlnum{0.1}
\end{alltt}
\begin{verbatim}
## [1] 0.3641666
\end{verbatim}
\begin{alltt}
\hldef{(lam3}\hlopt{-}\hldef{lam)}\hlopt{/}\hlnum{0.1}
\end{alltt}
\begin{verbatim}
## [1] 0.1349474
\end{verbatim}
