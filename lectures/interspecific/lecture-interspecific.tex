...
\begin{center}
  \includegraphics[width=\textwidth]{interspecific-predprey1}
\end{center}
\end{frame}
...
%  \begin{center}
    \includegraphics[width=0.49\textwidth]{interspecific-stable}
    \includegraphics[width=0.49\textwidth]{interspecific-compex}
%  \end{center}
\end{columns}
\end{frame}
