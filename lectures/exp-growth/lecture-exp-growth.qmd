...
## {content-align="center" style="font-size: 110%;" background-image="figs/doves" background-opacity=0.1}
...
%# From BIDE To Exponential Growth
# Geometric Growth
...
% 
  ...
  \begin{beamercolorbox}![](white)
    <center>
      ![](figs/MalthusGeometric)
      \hspace{0.1cm}
      ![](figs/MalthusBookCover)
    </center>
  \end{beamercolorbox}
  ...
  ## \Large Aldo Leopold, Game Management 1946
  ::: columns
    ::: {.column width='50%'}
      \small
%      \begin{quote}
      <center>
        ...
        rate. [] Thus one pair of quail, if entirely unmolested
...
%        \begin{quote}
        <center>
          ...
          absorbed by natural enemies, and part of it [] is
          absorbed by hunters.''
        </center>
%        \end{quote}
      }
...
%     \visible<3>{$\lambda = 1+r$ is the finite rate of increase}
  ...
  ## Three Possible Outcomes, $N_{t+1 = N_t + N_tr$}
  ::: columns
    ::: {.column width='50%'}
      \small
      \centering
...
**Definition**: Population growth rate ($r$) is *not* affected b population size ($N$). \\
