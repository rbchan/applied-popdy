...
\begin{frame}
  ...
  \vspace{0.5cm}
  {\bf Design} \\
  A random sample of animals is marked and followed over may periods
  (usually years) \\
%  {\bf Examples}
%  \begin{itemize}
...
%  \end{itemize}
  ...
  \begin{itemize}[<+->]
    ...
    animal died or left study area
...
%  \vspace{0.3cm}
  ...
  \vfill
  \uncover<2->{All we care about is survival, so ``condition'' on first encounter \\}
