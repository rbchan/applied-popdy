...
%    {February 6, 2019} \\
    \vfill
%    \includegraphics[height=3.5cm,keepaspectratio]{figs/Carolina-parakeet} \hspace{0.1cm}
...
%  {\bf Global}
  ...
  \begin{center}
    ...
    \\ %\hspace{0.5cm}
%    \includegraphics[height=2.5cm,keepaspectratio]{figs/honeycreepers} \\
    \vfill \tiny
%\url{http://www.discovery.com/tv-shows/racing-extinction/the-song-of-the-last-kauai-oo-bird/} \\
\url{https://vimeo.com/42592260}
  \end{center}
  }
%  {\bf Local}
%  \begin{itemize}
