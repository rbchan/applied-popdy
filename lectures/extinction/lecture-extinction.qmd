...
* Many believe that humans are causing the 6th mass extinction event
...
In addition to time to extinction ($T_e$), we are now interested in *extinction risk*. 
...
For a stochastic model, extinction risk can be calculated as the proportion of simulations in which the population goes extinct. 
...
## Logistic example, $r_{max=0.3$, $\bar{K}=100$, $\sigma^2=400$}
...
## Logistic example, $r_{max=0.3$, $\bar{K}=100$, $\sigma^2=1600$}
