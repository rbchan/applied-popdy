...
\begin{frame}[plain]
  \begin{center}
    {\huge Metapopulation models \par}
    \vspace{0.5cm}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Subpopulations are linked by dispersal
  ...
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{itemize}[<+->]
        ...
        \item Metapopulation models can be used to predict dynamics of
...
\begin{frame}
  \frametitle{Results}
  \includegraphics[width=\textwidth]{figs/col-ext}
\end{frame}
