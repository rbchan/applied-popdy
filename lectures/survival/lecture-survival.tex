...
\begin{alltt}
\hlkwd{library}\hldef{(survival)}                    \hlcom{## Load survival package}
\hldef{deer} \hlkwb{<-} \hlkwd{read.csv}\hldef{(}\hlsng{"deer_data.csv"}\hldef{)}    \hlcom{## Import data}
\hldef{S} \hlkwb{<-} \hlkwd{Surv}\hldef{(deer}\hlopt{$}\hldef{SurvTime, deer}\hlopt{$}\hldef{Fate)}  \hlcom{## Format survival data}
\hlkwd{plot}\hldef{(}\hlkwd{survfit}\hldef{(S}\hlopt{~}\hldef{deer}\hlopt{$}\hldef{Sex),} \hlkwc{lty}\hldef{=}\hlnum{1}\hlopt{:}\hlnum{2}\hldef{,}   \hlcom{## Kaplan-Meier}
     \hlkwc{main}\hldef{=}\hlsng{"Survivorship curve"}\hldef{,}
     \hlkwc{xlab}\hldef{=}\hlsng{"Days since capture (t)"}\hldef{,}
     \hlkwc{ylab}\hldef{=}\hlsng{"Probability of surviving to time t"}\hldef{,} \hlkwc{cex.lab}\hldef{=}\hlnum{1.5}\hldef{)}
\hlkwd{legend}\hldef{(}\hlnum{400}\hldef{,} \hlnum{1}\hldef{,} \hlkwd{c}\hldef{(}\hlsng{"Female"}\hldef{,} \hlsng{"Male"}\hldef{),} \hlkwc{lty}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{1}\hldef{,}\hlnum{2}\hldef{))}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{frame}
