...
::: {.beamer-block}
### Overcompensation
Density-dependent response in which populations over- or under-shoot
carrying capacity rather than approach it gradually. 
:::
...
::: {.beamer-block}
### Chaos
Highly variable deterministic dynamics that are extremely sensitive to
...
Ibex (*Capra ibex*) in Switzerland^[Data from S{\ae}ther et al. (2002). Figure from Krebs (2014)]
