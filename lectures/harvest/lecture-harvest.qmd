...
## Maximum sustainable yield {visibility="hidden"} 
...
::: {.r-stack}
::: {.fragment .fade-out fragment-index=1}
  ![](lecture-harvest_files/figure-revealjs/phibar1-1){width="70%"}
:::
::: {.fragment .fade-in fragment-index=1}
  ![](lecture-harvest_files/figure-revealjs/phibar2-1){width="70%"}
:::
:::
</center>
