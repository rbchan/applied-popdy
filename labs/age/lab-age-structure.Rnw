...
matplot(years, n, type="l", pch=16, xlab="Time", ylab="Abundance")
...
matplot(years, c, type="l", pch=16, ylim=c(0, 1), xlab="Time",
...
matplot(years[-1], ## There are nYears-1 *intervals* between years
        lambda.it, type="l", pch=16, xlab="Time", ylab="Growth rates")
