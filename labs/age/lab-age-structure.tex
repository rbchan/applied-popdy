...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{years} \hlkwb{<-} \hlnum{1}\hlopt{:}\hlnum{50}
...
\hlstd{lambda} \hlkwb{<-} \hlkwd{Re}\hlstd{(eA}\hlopt{$}\hlstd{values[}\hlnum{1}\hlstd{])}  \hlcom{## Dominant eigenvalue is the }
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{SADu} \hlkwb{<-} \hlkwd{Re}\hlstd{(eA}\hlopt{$}\hlstd{vectors[,}\hlnum{1}\hlstd{])}  \hlcom{## Right eigenvector is stable age dist}
...
\hlstd{RVu} \hlkwb{<-} \hlkwd{Re}\hlstd{(eAT}\hlopt{$}\hlstd{vectors[,}\hlnum{1}\hlstd{])} \hlcom{## Left eigenvector gives the RVs}
\hlstd{RV} \hlkwb{<-} \hlstd{RVu}\hlopt{/}\hlstd{RVu[}\hlnum{1}\hlstd{]}           \hlcom{## Standard to divide by first RV}
\hlstd{RV}
\end{alltt}
\begin{verbatim}
