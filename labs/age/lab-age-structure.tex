...
\begin{alltt}
\hlstd{A} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlkwd{c}\hlstd{(}  \hlnum{0}\hlstd{,} \hlnum{1.5}\hlstd{,} \hlnum{0.5}\hlstd{,}  \hlcom{## The fecundities}
              \hlnum{0.5}\hlstd{,}   \hlnum{0}\hlstd{,}   \hlnum{0}\hlstd{,}  \hlcom{## The first value is s1}
                \hlnum{0}\hlstd{,} \hlnum{0.9}\hlstd{,}   \hlnum{0}\hlstd{),} \hlcom{## The second value is s2}
