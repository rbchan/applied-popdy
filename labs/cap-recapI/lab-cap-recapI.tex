...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library(mra): there is no package called 'mra'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in F.huggins.estim(capture = \textasciitilde{}1, recapture = NULL, histories = ch.mat): could not find function "{}F.huggins.estim"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in F.huggins.estim(capture = \textasciitilde{}1, recapture = \textasciitilde{}1, histories = ch.mat): could not find function "{}F.huggins.estim"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in tvar(factor(1:6), nan = 17): could not find function "{}tvar"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in F.huggins.estim(capture = \textasciitilde{}time, recapture = NULL, histories = ch.mat): could not find function "{}F.huggins.estim"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'M0' not found}}\end{kframe}
\end{knitrout}
