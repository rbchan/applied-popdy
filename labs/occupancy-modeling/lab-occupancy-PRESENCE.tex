...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in validObject(.Object): invalid class "{}unmarkedFrame"{} object: siteCovData does not have same size number of sites as y.}}\end{kframe}
\end{knitrout}
