...
source("../../rnw2pdf.R")
rnw2pdf("lab-survival")
rnw2pdf("lab-survival", tangle=TRUE)
@
...

{
  \Large
  \centering
  {\bf Lab 12 -- Estimating survival from telemetry data} \\
  Due before Monday \\
}

\vspace{10pt}

The purpose of this lab is to learn how to use the R package `survival' to
estimate survival from telemetry data. Put your code and answers in a
Word file named something like ``Chandler-lab12.docx'', and upload it to ELC.
