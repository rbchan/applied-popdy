...
<<year>>=
year <- 1950:1961 # A vector containing the sequence of years
year              # Type the name of an object to see it's values
@
\pause
\vfill
<<nYears>>=
nYears <- length(year) # Returns the number of values in a vector
nYears
@
\end{frame}
