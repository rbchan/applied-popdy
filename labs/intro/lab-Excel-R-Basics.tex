...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item[4.] Grad students only\footnote{Undergrads will receive 10
        bonus points for doing labs in Excel and R}: Do steps
      1-3 using Excel, and also replicate the process using a ``for
