...
%  (\url{https://www.rstudio.com/}) \\
  %% \href{https://posit.co/download/rstudio-desktop/}{\bf RStudio} \\
%  \href{https://posit.co/download/rstudio-desktop/}{\bf RStudio} \\
  or {\bf RStudio}  (\url{https://posit.co/download/rstudio-desktop/}) \\  
  \pause
  \vfill
...
\begin{alltt}
\hldef{year} \hlkwb{<-} \hlnum{1950}\hlopt{:}\hlnum{1961} \hlcom{# A vector of integers}
\hldef{year}              \hlcom{# Type the name of an object to see its values}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{updown} \hlkwb{<-} \hlkwd{c}\hldef{(}\hlkwd{seq}\hldef{(}\hlkwc{from}\hldef{=}\hlnum{20}\hldef{,} \hlkwc{to}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{by}\hldef{=}\hlnum{20}\hldef{),} \hlkwd{seq}\hldef{(}\hlkwc{from}\hldef{=}\hlnum{100}\hldef{,} \hlkwc{to}\hldef{=}\hlnum{20}\hldef{,} \hlkwc{by}\hldef{=}\hlopt{-}\hlnum{20}\hldef{))}
\hldef{updown}            \hlcom{# Two sequences, combined}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{nYears} \hlkwb{<-} \hlkwd{length}\hldef{(year)}
\hldef{nYears}
\end{alltt}
\begin{verbatim}
## [1] 12
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{females} \hlkwb{<-} \hlkwd{rep}\hldef{(}\hlnum{NA}\hldef{, nYears)}
\hldef{females[}\hlnum{1}\hldef{]} \hlkwb{<-} \hlnum{100}
\end{alltt}
\end{kframe}
\end{knitrout}
\pause
...
\hlkwa{for}\hldef{(t} \hlkwa{in} \hlnum{2}\hlopt{:}\hldef{nYears) \{}
    \hldef{females[t]} \hlkwb{<-} \hldef{females[t}\hlopt{-}\hlnum{1}\hldef{]} \hlopt{+} \hldef{females[t}\hlopt{-}\hlnum{1}\hldef{]}\hlopt{*}\hlnum{0.01}
\hldef{\}}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{males} \hlkwb{<-} \hldef{females}\hlopt{*}\hlnum{0.8}
\end{alltt}
\end{kframe}
\end{knitrout}
    \end{column}
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{model1} \hlkwb{<-} \hlkwd{data.frame}\hldef{(year, females, males)}
\hldef{model1}
\end{alltt}
\begin{verbatim}
##    year  females    males
...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hldef{(females} \hlopt{~} \hldef{year,} \hlkwc{data}\hldef{=model1,} \hlkwc{type}\hldef{=}\hlsng{"o"}\hldef{,} \hlkwc{xlab}\hldef{=}\hlsng{"Year"}\hldef{,} \hlkwc{ylab}\hldef{=}\hlsng{"Abundance"}\hldef{,}
     \hlkwc{lwd}\hldef{=}\hlnum{2}\hldef{,} \hlkwc{pch}\hldef{=}\hlnum{16}\hldef{,} \hlkwc{ylim}\hldef{=}\hlkwd{c}\hldef{(}\hlnum{0}\hldef{,} \hlnum{120}\hldef{))}
\hlkwd{lines}\hldef{(males} \hlopt{~} \hldef{year,} \hlkwc{data}\hldef{=model1,} \hlkwc{type}\hldef{=}\hlsng{"o"}\hldef{,} \hlkwc{col}\hldef{=}\hlsng{"blue"}\hldef{,} \hlkwc{lwd}\hldef{=}\hlnum{2}\hldef{,} \hlkwc{pch}\hldef{=}\hlnum{16}\hldef{)}
\hlkwd{legend}\hldef{(}\hlkwc{x}\hldef{=}\hlnum{1950}\hldef{,} \hlkwc{y}\hldef{=}\hlnum{40}\hldef{,} \hlkwc{legend}\hldef{=}\hlkwd{c}\hldef{(}\hlsng{"Females"}\hldef{,} \hlsng{"Males"}\hldef{),} \hlkwc{col}\hldef{=}\hlkwd{c}\hldef{(}\hlsng{"black"}\hldef{,} \hlsng{"blue"}\hldef{),} \hlkwc{lty}\hldef{=}\hlnum{1}\hldef{,} \hlkwc{pch}\hldef{=}\hlnum{16}\hldef{)}
\end{alltt}
\end{kframe}
