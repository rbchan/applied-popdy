...
\definecolor{shadecolor}{rgb}{0.878, 0.918, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{updown} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlkwd{seq}\hlstd{(}\hlkwc{from}\hlstd{=}\hlnum{20}\hlstd{,} \hlkwc{to}\hlstd{=}\hlnum{100}\hlstd{,} \hlkwc{by}\hlstd{=}\hlnum{20}\hlstd{),} \hlkwd{seq}\hlstd{(}\hlkwc{from}\hlstd{=}\hlnum{100}\hlstd{,} \hlkwc{to}\hlstd{=}\hlnum{20}\hlstd{,} \hlkwc{by}\hlstd{=}\hlopt{-}\hlnum{20}\hlstd{))}
\hlstd{updown}            \hlcom{# Two sequences, combined}
\end{alltt}
\begin{verbatim}
