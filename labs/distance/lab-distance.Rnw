...
The structure of the data can assessed like this:
...
Once you have fitted the model, you can summarize the output and view
the detection function using commands such as:
